...
open class SuperClass1{
    ...
    fun superMethod1(){
        ...
        // SuperClass1을 상속받은 클래스가 다른 클래스가 있을 수도 있고
        // SuperClass1을 가지고 객체를 생성했을 수도 있기 때문이다.
//        println("subA2 : $subA2")
//        subMethod2()
    }
}
...
// 생성자를 정의하는 자식 클래스
// 생성자를 정의하면 부모클래스 이름 옆에 ( ) 를 통해 생성자를 호출하는 것은
// 빼야 한다.
// 생성자에서 부모가 가진 매개변수가 없는 생성자가 자동으로 호출되기 때문이다.
...
// 부모클래스에 주 생성자가 정의되어 있다고 하더라도
// 부모의 생성자를 지정하지 않으면 무조건 매개변수가 없는 생성자를
// 호출하려고 한다.
